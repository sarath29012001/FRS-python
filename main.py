...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vasanthvishva.mm@gmail.com' ")
...
img = ImageTk.PhotoImage(file="C:\\Users\\LENOVO\\Downloads\\FRS\\bgforproj.png")
label = Label(
    window,
    image=img
)
...
message3 = tk.Label(window, text="Face Recognition Based Attendance System" ,fg="white",bg="black",width=0 ,height=0,font=('times', 29, ' bold '))
message3.place(x=0, y=0)

frame3 = tk.Frame(window, bg="red")
frame3.place(relx=0.52, rely=0.09, relwidth=0.09, relheight=0.07)

frame4 = tk.Frame(window, bg="red")
frame4.place(relx=0.36, rely=0.09, relwidth=0.16, relheight=0.07)

datef = tk.Label(frame4, text =  day+"-"+mont[month]+"-"+year+"  |  ", fg="black",bg="white" ,width=55 ,height=1,font=('times', 15, ' bold '))
datef.pack(fill='both',expand=1)


clock = tk.Label(frame3,fg="blue",bg="whitesmoke" ,width=55 ,height=1,font=('times', 15, ' bold '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="white",bg="red2" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="white",bg="red2" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)
...
message1 = tk.Label(frame2, text="OPTIONS" ,bg="cyan2" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="cyan2" ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="white"  ,bg="gray25"  ,height=1 ,font=('times', 17, ' bold '))
...
quitWindow = tk.Button(frame1, text="Exit", command=window.destroy  ,fg="black"  ,bg="yellow"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
